...
def render_escalation_modal():
    ...
    esc_html = """<div style="background: rgba(17, 24, 39, 0.95); border: 2px solid rgba(239, 68, 68, 0.5); border-radius: 16px; padding: 24px; margin-bottom: 20px; box-shadow: 0 0 40px rgba(239, 68, 68, 0.25);">
...
<span class="badge-live" style="background: rgba(239, 68, 68, 0.2); border-color: rgba(239, 68, 68, 0.4); color: #EF4444;">TRANSFER PENDING</span>
</div>
...
<div style="background: rgba(0, 0, 0, 0.3); padding: 16px; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.05);">
<div style="font-size: 12px; font-weight: 700; color: #60A5FA; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 8px;">📝 AI Call Context Summary</div>
<div style="font-size: 12.5px; line-height: 1.4; color: var(--text-primary); margin-bottom: 12px;">Caller reports payment was deducted yesterday, but the order (#73821) remains unconfirmed on the dashboard.</div>
